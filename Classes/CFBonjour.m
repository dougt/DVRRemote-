...
MyBrowserCallback(CFNetServiceBrowserRef browser, CFOptionFlags flags, CFTypeRef domainOrService, CFStreamError* error, void* info)
{
    ...
    /*
     2009-02-01 18:15:21.527 DVR Music[1899:20b] *** Terminating app due to uncaught exception 'NSGenericException', reason: '*** Collection <NSCFArray: 0x122840> was mutated while being enumerated.'
    
     IF YOU really want this to work, you can do something like just set a flag instead of removing an element
     */
    
    if (flags & kCFNetServiceFlagRemove && false){                       //service needs to be removed
